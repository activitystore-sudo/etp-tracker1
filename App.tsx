...
import Page_2 from "./pages/admin.user-approval.tsx";
import PageLayout_2 from "./pages/admin.user-approval.pageLayout.tsx";
...
const fileNameToRoute = new Map([["./pages/login.tsx","/login"],["./pages/_index.tsx","/"],["./pages/admin.user-approval.tsx","/admin/user-approval"]]);
const fileNameToComponent = new Map([
    ["./pages/login.tsx", Page_0],
["./pages/_index.tsx", Page_1],
["./pages/admin.user-approval.tsx", Page_2],
  ]);
...
"./pages/admin.user-approval.tsx": PageLayout_2,
